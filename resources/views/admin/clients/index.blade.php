...
<table id="myTable" class="table table-striped table-bordered" style="width:100%;">
    <caption>Clientes corporativos</caption>
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><img src="{{ asset('/img/clients/'.$client->imagen) }}" width="100" alt="Robot 1"/></th>
          <td>{{ $client->name }}</td>
          ...
          <form method="post" action="{{ route('clients.update', ['client' => $client]) }}" id="form_{{ $client->id }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
              <div class="form-group offset-2 col-md-10">
                <img src="{{ asset('/img/clients/'.$client->imagen) }}" width="100" alt="Robot 1"/>
              </div>
            </div>
              <div class="row">
          ...
          <form method="post" action="{{ route('clients.destroy', ['client' => $client]) }}" id="form-{{ $client->id }}" enctype="multipart/form-data">
            @csrf
            @method('DELETE')
          <!-- Modal -->
          ...
          <div class="modal-body">
            <h3 class="text-center">¿Esta seguro de eliminar este cliente corporativo?</h3>
          </div>
          <div class="modal-footer">
...
<div class="modal-content">
  ...
  <div class="modal-header">
    ...
    <h5 class="modal-title">Crear clientes corporativos</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      <span aria-hidden="true">&times;</span>
    </button>
  </div>
